...
hi def link rubyClass			Special
hi def link rubyModule			Special
hi def link rubyMethodExceptional	Function
hi def link rubyDefine			Boolean
...
hi def link rubySymbol			Boolean
hi def link rubyKeyword			Keyword
hi def link rubyOperator		Operator
hi def link rubyBeginEnd		SpecialComment
