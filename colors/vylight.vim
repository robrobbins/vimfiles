...
hi Directory     guifg=#597f95  guibg=NONE
hi SpecialKey    guifg=#bebebe  guibg=NONE
...
if version >= 700
  ...
  hi PmenuSel    guifg=white    guibg=#90a0ae  gui=bold
  ...
  hi CursorLine  guifg=#ffffff  guibg=#90a0ae
  hi ColorColumn                guibg=#fafafa
endif


" Syntax highlighting 
hi Comment       guifg=#777777  gui=none       gui=italic
...
" More Groups
hi javaScriptFunction  guifg=#bb3355 guibg=NONE gui=NONE
